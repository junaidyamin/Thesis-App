...
# List of 27 factors
factors = [
    "Complexity of the Project", "Client Requirements", "Regulatory Requirements", "Strict Maintenance Requirements", "Safety Requirements",
    "Data Privacy and Security Requirements", "Feasibility of Generating Federated Model of Project", "Remote Location", "Harsh Weather Conditions", "Unstable Soil and Ground Conditions",
    "Presence of Physically Inaccessible Project Elements", "Awareness, Knowledge, and Expertise of project actors in DT", "Organizational Readiness to Adopt DT", "Availability of Enabling Technologies", "Availability of High-quality Federated Data",
    "Presence of Supportive Regulations", "Real-time Monitoring and Automated Project Control", "Safety Monitoring", "Data-Driven Project Planning and Logistics", "Asset Performance Assessment",
    "Smart Design", "Quality Assessment and Controls", "Minimal Construction Defects and Reworks", "Availability of funds and affordability of the solution", "Greenfield vs. Brownfield",
    "Size of project", "Cost of implementation"
]

# Define recommendations for each factor based on score
factor_recommendations = {
    "Complexity of the Project": {1: "Considering the very low complexity of the project, it may not be necessary to implement a DT.",
    ...
    "Client Requirements": {1: "It is not essential to implement DT as the Client does not require it.",
    ...
    "Regulatory Requirements": {1: "Consider less complicated tools and techniques when regulatory requirements are low",
    ...
    "Strict Maintenance Requirements": {1: "Ensure to focus on basic maintenance practices and traditional methods to ensure system reliability and performance",
    ...
    "Safety Requirements": {1: "Consider using simpler tools and methods to meet safety needs without significant investment in DT",
    ...
    "Data Privacy and Security Requirements": {1: "Focus on basic data protection practices and ensure compliance with minimal security standards using traditional methods",
    ...
    "Feasibility of Generating Federated Model of Project": {1: "Focus on traditional project management and coordination methods, as the effort and resources required to create a federated model may not be justified given the low feasibility",
    ...
    "Remote Location": {1: "Invest resources on the on-site visit and simpler remote management tools to manage the project effectively ",
    ...
    "Harsh Weather Conditions": {1: "Commit to use simpler tools can help in planning and mitigating occasional weather disruptions",
    ...
    "Unstable Soil and Ground Conditions": {1: "Consider simpler geotechnical monitoring tools if the DT's advantages are minimal",
    ...
    "Presence of Physically Inaccessible Project Elements": {1: "Focus on standard project management practices without involving DT",
    ...
    "Awareness, Knowledge, and Expertise of project actors in DT": {1: "Focus on basic training and building foundational knowledge about DT among the team before introducing DT",
    ...
    "Organizational Readiness to Adopt DT": {1: " Invest in preliminary steps to improve organizational readiness, such as training key stakeholders, establishing a digital transformation strategy, and securing leadership buy-in",
    ...
    "Availability of Enabling Technologies": {1: "Identify the specific technologies that are lacking and create a plan to acquire and integrate these technologies incrementally",
    ...
    "Availability of High-quality Federated Data": {1: "Develop a phased plan to enhance data collection, management practice sand work on improving data quality and integration",
    ...
    "Presence of Supportive Regulations": {1: "Assess the specific regulatory obstacles and develop strategies to navigate them",
    ...
    "Real-time Monitoring and Automated Project Control": {1: "Focus on traditional project management methods and manual controls to oversee project activities",
    ...
    "Safety Monitoring": {1: "Use manual monitoring or other low key safety management methods to ensure project safety",
    ...
    "Data-Driven Project Planning and Logistics": {1: "Consider manual logistics management or starting with simpler digital tools to enhance planning and logistics",
    ...
    "Asset Performance Assessment": {1: "Ensure periodic inspections and manual performance evaluations without DT adoption",
    ...
    "Smart Design": {1: "Prioritize conventional design methodologies and collaborative planning processes",
    ...
    "Quality Assessment and Controls": {1: "Ensure consistent manual inspections and periodic audits to improve decision making",
    ...
    "Minimal Construction Defects and Reworks": {1: "Arrange frequent onsite supervisions and manual inspections to reduce construction defects and reworks",
    ...
    "Availability of funds and affordability of the solution": {1: "Explore grants, subsidies, or partnerships that could provide additional funding otherwise improve efficiency with low cost",
    ...
    "Greenfield vs. Brownfield": {1: "Focus on basic project management tools and traditional methods suited for either Greenfield (new construction) or Brownfield (modifying existing structures) environments.",
    ...
    "Size of project": {1: "Consider using basic digital solutions for specific tasks and reassess the need for a comprehensive digital twin as the project scope or complexity increases",
    ...
    "Cost of implementation": {1: "Prioritize low-cost or free digital tools to manage the project",
...
# Streamlit app title
st.title("Decision Support System for Implementing Digital Twin in Construction")

# User input for each factor using a drop-down menu
for factor in factors:
    user_input[factor] = st.selectbox(f"{factor}", options=[1, 2, 3, 4, 5])
...
if st.button("Submit"):
    ...
    st.write("You are recommended to:")
    for factor, score in user_input.items():
        if score in factor_recommendations[factor]:
            st.write(f"{factor}: {factor_recommendations[factor][score]}")
